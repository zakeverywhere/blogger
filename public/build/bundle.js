	...
	_createClass(App, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				{ store: _store2.default.configure() },
...
var _Blogs = __webpack_require__(41);
...
var _Blog = __webpack_require__(42);
...
var Blogs = function (_Component) {
	...
	_createClass(Blogs, [{
		...
		key: 'render',
		value: function render() {
			var listItems = this.props.blogsList.map(function (blog, i) {
				return _react2.default.createElement(
					_Blog2.default,
					{ key: i, title: blog.title, content: blog.content },
					' '
				);
			});

			var listItems2 = this.props.blogsList.map(function (blog, i) {
				return _react2.default.createElement(
					_Blog2.default,
					{ key: i, title: blog.title, content: blog.content },
					' '
			...
			return _react2.default.createElement(
				...
				listItems,
				listItems2,
				_react2.default.createElement(_Blog2.default, { title: 'blah', content: 'blah1' }),
				_react2.default.createElement(_Blog2.default, { title: 'blah2', content: 'blah1' }),
				_react2.default.createElement(_Blog2.default, { title: 'blah4', content: 'blah1' }),
				_react2.default.createElement(_Blog2.default, { title: 'blah4', content: 'blah1' }),
				_react2.default.createElement(_Blog2.default, { title: 'blah4', content: 'blah1' }),
				_react2.default.createElement(_Blog2.default, { title: 'blah4', content: 'blah1d' })
			);
		}
	}]);
...
var dispatchToProps = function dispatchToProps(dispatch) {
	return {
		blogsReceived: function blogsReceived(blogs) {
			dispatch(_actions2.default.blogsReceived(blogs));
		}
	};
};
exports.default = (0, _reactRedux.connect)(stateToProps, dispatchToProps)(Blogs);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23), __webpack_require__(63)(module)))
...
var _blogReducer = __webpack_require__(74);
...
exports.default = function () {
	...
	switch (action.type) {
		case _constants2.default.BLOGS_RECEIVED:
...
exports.default = {
	blogsReceived: function blogsReceived(blogs) {
		return {
			type: _constants2.default.BLOGS_RECEIVED,
			blogs: blogs
		};
	}
};
